...
export VLLM_VERSION="0.28.0rc1"
export VLLM_ROCM_VERSION="7.14"
export VLLM_PYTORCH_VERSION="v2.13.0"

# KIntegrated vLLM gfx906/v0.28.0rc1: upstream v0.28.0rc1 merged onto the
...
export VLLM_BRANCH="gfx906/v0.28.0rc1"
export VLLM_COMMIT="a44efc1a95"
